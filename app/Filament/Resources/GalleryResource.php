...
class GalleryResource extends Resource
{
    ...
    {
        return $form->schema([
            Forms\Components\FileUpload::make('image_path')->label('Gambar')->image()->imageEditor()
                ->required()->directory('gallery')->maxSize(4096)->columnSpanFull(),
            ...
            Forms\Components\TextInput::make('alt_text')->label('Alt text (SEO)'),
    ...
    public static function table(Table $table): Table
    {
        return $table
            ...
            ->columns([
                ...
                Tables\Columns\TextColumn::make('caption')->label('Caption')->limit(30),
                Tables\Columns\IconColumn::make('is_active')->label('Aktif')->boolean(),
            ])
            ->filters([
                Tables\Filters\SelectFilter::make('category')->options([
                    'makanan' => 'Makanan', 'tempat' => 'Tempat', 'acara' => 'Acara',
                    'pempek' => 'Pempek', 'suasana' => 'Suasana', 'lainnya' => 'Lainnya',
                ]),
